...
namespace pocketpd {
    ...
    class EnergyStage : public App::Stage,
                        public App::UseLog<EnergyStage>,
                        public App::UseRender<EnergyStage, EnergyView> {
    private:
    ...
    public:
        ...
        explicit EnergyStage(OutputGate& output_gate) : m_output_gate(output_gate) {}
    ...
    public:
        EnergyViewModel view_model() const {
